...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "subCategories", "objectService" : "BestBuyObjectServices"};
    ...
    function subCategories(defaultValues) {
        var privateState = {};
        context["field"] = "categoryId";
        context["metadata"] = (objectMetadata ? objectMetadata["categoryId"] : null);
    ...
    BaseModel.isParentOf(subCategories);

    //Create new class level validator object
    BaseModel.Validator.call(subCategories);

    var registerValidatorBackup = subCategories.registerValidator;

    subCategories.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(subCategories.isValid(this, propName, val)) {
    ...
    subCategories.relations = relations;

    subCategories.prototype.isValid = function() {
        return subCategories.isValid(this);
    };

    subCategories.prototype.objModelName = "subCategories";
     ...
     */
    subCategories.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("BestBuyObjectServices", "subCategories", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    subCategories.clone = function(objectToClone) {
        var clonedObj = new subCategories();
